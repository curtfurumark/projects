...
public class Constants {
    public static final String INTENT_ADD_TASK = "intent_add_task";
    ...
    public static final String INTENT_EDIT_LIST_ITEM ="INTENT_EDIT_LIST_ITEM";
    public static final String INTENT_CREATE_ROOT_ITEM ="INTENT_CREATE_LIST_ITEM";
